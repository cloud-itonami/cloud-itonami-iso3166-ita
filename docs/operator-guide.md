...
2. Register the client's intake: business type, target public function,
   prior filing history in Italy if any.
3. Run the advisor in read-only mode against MEPA (Mercato Elettronico della Pubblica Amministrazione), Italy's national e-procurement marketplace operated by CONSIP.
...
- named referral relationship with Italian-licensed counsel or a
...
a working referral relationship with Italian-licensed counsel or a
registered agent for whatever licensed representation the law of
Italy requires for actual public-procurement filings.
